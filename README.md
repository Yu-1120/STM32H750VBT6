...
![STM32CubeProgrammer 串口下载2](README.assets/stm32cubeprog串口2.png)
...
4. 下载结果如图所示
   ![img](README.assets/WeActStudioUARTDownLoader2.png)
...
1. 修改工程ROM起始地址为 `0x8004000`
   ...
   ![Keil MDK 设置](README.assets/APPSetup1MDK.png)
